		      	...
		      	<div class="row">
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="#">
							<img src="images/sofa_1.png" class="img-fluid product-thumbnail">
							<h3 class="product-title">'.$name_1.'</h3>
							<h6 class="description">'.$description_1.'</h6>
							<strong class="product-price">'.$price_1.'</strong>
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="#">
							<img src="images/sofa_2.png" class="img-fluid product-thumbnail">
							<h3 class="product-title">'.$name_1.'</h3>
							<h6 class="description">'.$description_1.'</h6>
							<strong class="product-price">'.$price_1.'</strong>
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="#">
							<img src="images/sofa_3.png" class="img-fluid product-thumbnail">
							<h3 class="product-title">'.$name_1.'</h3>
							<h6 class="description">'.$description_1.'</h6>
							<strong class="product-price">'.$price_1.'</strong>
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="#">
							<img src="images/sofa_4.png" class="img-fluid product-thumbnail">
							<h3 class="product-title">'.$name_1.'</h3>
							<h6 class="description">'.$description_1.'</h6>
							<strong class="product-price">'.$price_1.'</strong>
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<a class="product-item" href="#">
							<img src="images/sofa_5.png" class="img-fluid product-thumbnail">
							<h3 class="product-title">'.$name_1.'</h3>
							<h6 class="description">'.$description_1.'</h6>
							<strong class="product-price">'.$price_1.'</strong>
